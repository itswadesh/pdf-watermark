...
(function () {
    ...
    var pdffiller = {
        ...
        addWatermark: function (sourceFile, destinationFile, watermarkFile, callback) {
            // pdftk <exisitng_pdf> multistamp <wtaermark_pdf> output <new_pdf>
            var args = [sourceFile, "multistamp", watermarkFile, "output", destinationFile];
            execFile("pdftk", args, function (error, stdout, stderr) {
                if (error) {
                    console.log('exec error: ' + error);
                    return callback(error);
